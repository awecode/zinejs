...
export interface ZineOptions {
  ...
  /** Page-curl model for the WebGL2 renderer: 'roll' | 'cone' | 'simple' | 'fold' | 'peel'. Default 'roll'. */
  curl?: CurlType;
...
export class Zine {
  ...
  #maybeClickFlip(gesture: GestureEnd): void {
    ...
    // Anchor the fold at the tapped height (cone/fold/peel curl from where you tap).
